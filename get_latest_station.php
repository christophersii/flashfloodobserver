...
$sql = "SELECT sr.device_id, s.station_code, s.station_name, s.latitude, s.longitude, s.threshold_alert, s.threshold_warning, s.threshold_danger, s.drainage_depth, sr.water_level, sr.rainfall, sr.temperature, sr.humidity, s.drainage_depth - sr.water_level AS drainage_water_level, sr.reading_time
FROM station s
