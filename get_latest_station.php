...
$sql = "SELECT sd.device_id, s.station_code, s.station_name, s.latitude, s.longitude, s.threshold_alert, s.threshold_warning, s.threshold_danger, s.drainage_depth, sr.water_level, sr.rainfall, sr.temperature, sr.humidity, s.drainage_depth - (sr.water_level - 30) AS drainage_water_level, sr.reading_time
FROM station s
...
$stmt->bind_result($device_id, $station_code, $station_name, $latitude, $longitude, $threshold_alert, $threshold_warning, $threshold_danger, $drainage_depth, $water_level, $rainfall, $temperature, $humidity, $drainage_water_level, $reading_time);
